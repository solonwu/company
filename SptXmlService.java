...
public class SptXmlService {
    ...
    private List<FatcaXmlBuilder.AccountReportSpec> queryAccountReports(String giin) {
        ...
        for (BaseRow base : baseRows) {
            ...
            PersonHolder person = personByAccount.get(base.accountNumber());
            ...
            boolean useOrg = isOrgFlag ? org != null : (person == null && org != null);
            boolean useIndividual = !useOrg && person != null;
